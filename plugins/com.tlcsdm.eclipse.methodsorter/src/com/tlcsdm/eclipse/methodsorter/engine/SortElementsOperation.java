...
public class SortElementsOperation extends JavaModelOperation {
	...
	/**
	 * Returns the amount of work for the main task of this operation for progress
	 * reporting.
	 */
	...
	public TextEdit calculateEdit(org.eclipse.jdt.core.dom.CompilationUnit unit, TextEditGroup group)
		...
		if (!(this.elementsToProcess[0] instanceof ICompilationUnit))
			throw new JavaModelException(
					new JavaModelStatus(IJavaModelStatusConstants.INVALID_ELEMENT_TYPES, this.elementsToProcess[0]));
	 ...
	 * Possible failures:
	 * <ul>
	 * <li>NO_ELEMENTS_TO_PROCESS - the compilation unit supplied to the operation
