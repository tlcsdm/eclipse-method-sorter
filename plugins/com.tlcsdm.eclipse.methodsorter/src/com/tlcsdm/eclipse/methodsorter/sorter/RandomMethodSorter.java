...
import com.tlcsdm.eclipse.methodsorter.sorter.comparator.ComparatorFactory;
...
public class RandomMethodSorter implements IMethodSorter {
	...
	/**
	 * Comparator that sorts MethodDeclarations by an ordering associated with their
	 * unique key. This ordering is pre-calculated and passed at instantiation. All
	 * other declarations are sorted preserving their old relative order.
	 */
