 ...
 *
 */
package com.tlcsdm.eclipse.methodsorter.sorter.callgraph;
...
public class CallGraphExtractor extends TopLevelASTVisitor {
	...
	public boolean visit(MethodInvocation methodInvocation) {
		...
		if (isInstanceInvocation(methodInvocation)) {
			...
			/*
			 * TODO currentCaller == null only happens with static field initializers before
			 * any method declaration in the source. Since static field initializers CAN
			 * appear somewhere after a method declaration, checking for currentCaller ==
			 * null is no safe method to detect static field initializers. At the moment
			 * there is no fast solution visible. For the moment we just ignore static field
