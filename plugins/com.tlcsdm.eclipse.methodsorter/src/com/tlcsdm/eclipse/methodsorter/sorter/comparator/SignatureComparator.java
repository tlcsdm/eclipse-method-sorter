...
public class SignatureComparator implements Comparator<Signature> {
	 ...
	 * comparator.
	 *
	 * @param defaultSortPositionFlag when true, not found signatures are sorted
	 *                                BEFORE the known signatures. When set to
	 *                                false, not found signatures are sorted AFTER
	 *                                known signatures.
	 *
	 */
