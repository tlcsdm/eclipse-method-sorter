 ...
 *
 */
package com.tlcsdm.eclipse.methodsorter.sorter.cluster;
...
import com.tlcsdm.eclipse.methodsorter.sorter.callgraph.TopLevelASTVisitor;
...
public class ClusterGraphExtractor extends TopLevelASTVisitor {
	...
	/**
	 * A method is a setter when it starts with "set" and has only one parameter.
	 *
	...
	/**
	 * @param methodDeclaration1 return type of this method is taken into account.
	 * @param MethodDeclaration2 the type of the first parameter is taken into
	 *                           account
	 * @return
	 */
